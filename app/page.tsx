...
const talentProfiles = [
  {
    ...
    city: "Mexico City",
    icon: (
      <Terminal className="w-8 h-8 text-neutral-400 group-hover:text-[var(--accent-color)] transition-colors duration-200" />
    ),
    name: "Sofia M.",
  ...
  },
  {
    ...
    city: "São Paulo",
    icon: (
      <Server className="w-8 h-8 text-neutral-400 group-hover:text-[var(--accent-color)] transition-colors duration-200" />
    ),
    name: "Mateus S.",
    role: "Backend Lead",
    exp: "8 YOE",
  ...
  },
  {
    ...
    city: "Guadalajara",
    icon: (
      <CodeIcon className="w-8 h-8 text-neutral-400 group-hover:text-[var(--accent-color)] transition-colors duration-200" />
    ),
    name: "Diego R.",
    role: "Senior Backend",
    exp: "10 YOE",
  ...
  },
  {
    ...
    city: "Buenos Aires",
    icon: (
      <Database className="w-8 h-8 text-neutral-400 group-hover:text-[var(--accent-color)] transition-colors duration-200" />
    ),
    name: "Julian G.",
  ...
  },
  {
    ...
    city: "Lima",
    icon: (
      <Layout className="w-8 h-8 text-neutral-400 group-hover:text-[var(--accent-color)] transition-colors duration-200" />
    ),
    name: "Elena V.",
  ...
  },
  {
    ...
    city: "Montevideo",
    icon: (
      <Cloud className="w-8 h-8 text-neutral-400 group-hover:text-[var(--accent-color)] transition-colors duration-200" />
    ),
    name: "Lucas B.",
  ...
  return (
    <div ref={ref} className="relative group cursor-default flex flex-col items-center md:items-start">
      <div className="flex items-start">
        ...
        <span className="text-4xl md:text-6xl font-bold text-[var(--accent-color)] group-hover:text-black transition-colors duration-300 mt-4 md:mt-8">
          +
        </span>
      </div>
      ...
      <div className="mt-6 text-center md:text-left">
        <p className="text-2xl md:text-4xl font-bold text-black tracking-normal leading-tight mb-2">{label}</p>
        <p className="text-lg md:text-xl text-neutral-400 font-medium">{subLabel}</p>
      </div>
    </div>
  );
};
      ...
      {showColorPicker && (
        <div className="fixed bottom-16 right-4 md:bottom-20 md:right-6 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
          <div className="bg-white border border-neutral-200 p-3 md:p-4 rounded-xl shadow-2xl">
            ...
            <div className="mt-2 md:mt-3 text-center text-xs text-neutral-400 font-medium">Pick your vibe</div>
          </div>
        </div>
      )}
          ...
          <div className="max-w-7xl mx-auto relative">
            <div className="max-w-5xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-start">
                <Link
                  href="/companies"
                  className="group px-8 py-4 bg-black text-white font-semibold text-lg hover:bg-[var(--accent-color)] hover:text-black transition-colors duration-200 active:scale-[0.98] inline-flex items-center justify-center gap-3"
                >
                  Hire Engineers{" "}
                ...
                <Link
                  href="/talent"
                  className="flex items-center justify-center px-8 py-4 text-neutral-500 hover:text-black font-semibold text-lg transition-colors duration-200"
                >
                  I&apos;m an Engineer
                </Link>
              </div>
              ...
              <div key={setIndex} className="flex items-center shrink-0">
                {cities.map((city, i) => (
                  <React.Fragment key={`${setIndex}-${i}`}>
                    <span className="text-3xl md:text-4xl font-bold text-neutral-300 tracking-normal hover:text-[var(--accent-color)] transition-colors duration-200 cursor-default px-8">
                      {city}
                    </span>
        ...
        <section className="py-24 md:py-32 px-4 md:px-6 bg-gradient-to-b from-neutral-50 to-white border-y border-neutral-200 overflow-hidden">
          <div className="max-w-7xl mx-auto">
            <div className="mb-16 md:mb-20">
              <h2 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight text-black">
                Why <span className="text-[var(--accent-color)]">LATAM</span>?
              </h2>
            ...
            <div className="mb-16">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 max-w-4xl mx-auto">
                ...
                <div className="text-center p-8 rounded-2xl transition-all duration-300 hover:bg-neutral-100 group">
                  <div className="mb-4">
                    <span className="text-6xl md:text-7xl font-bold text-neutral-800 transition-colors duration-300 group-hover:text-[var(--accent-color)]">
                      9
                    </span>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12 md:mb-16 max-w-2xl">
              ...
              <p className="text-lg md:text-xl text-neutral-600">
                From first call to first hire. Usually under two weeks.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8 relative">
              ...
              {[
                ...
                { num: 2, title: "We Search", text: "We tap our network. Real conversations, not keyword matching." },
                {
                  num: 3,
                  title: "We Interview",
                  text: "A technical deep-dive by people who've shipped code. We know what good looks like.",
                },
                { num: 4, title: "You Meet Them", text: "3-5 candidates who actually fit. Ready to talk this week." },
              ].map((step) => (
                <div
                  key={step.num}
                  className="relative bg-white border border-neutral-200 p-8 hover:border-[var(--accent-color)] hover:shadow-lg transition-all duration-200 group rounded-xl h-full"
                >
        ...
        <section className="py-24 md:py-32 px-4 md:px-6 bg-neutral-50 border-y border-neutral-200 relative">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 md:mb-8 text-black leading-tight">
                One number.
              </h2>
              <p className="text-lg md:text-2xl text-neutral-600 mb-8 md:mb-12 font-medium">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-neutral-500 font-medium">
                      Not working out? We find someone else. No charge.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-neutral-500 font-medium">
                      Every candidate gets real feedback. Win or lose.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-neutral-200 p-8 md:p-16 rounded-3xl relative group hover:border-[var(--accent-color)] hover:shadow-xl transition-all duration-200 shadow-lg">
                ...
                <div className="text-center">
                  <div className="flex items-baseline justify-center gap-2">
                    <span className="text-[8rem] md:text-[10rem] leading-none font-bold text-black tracking-tighter">
                      15
                    </span>
        ...
        <section className="py-24 md:py-32 border-t border-neutral-200 bg-neutral-50 overflow-hidden">
          ...
          >
            {talentProfiles.map((profile) => (
              <div key={profile.id} className="min-w-[300px] md:min-w-[400px] snap-center">
                  ...
                  <div className="space-y-6 mt-10">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {profile.tech.map((tech) => (
                        <span
                          key={tech}
                          className="px-4 py-2 bg-neutral-100 border border-neutral-200 rounded-lg text-sm font-bold text-neutral-700"
                        >
                          {tech}
                        </span>
                      ))}
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="relative rounded-3xl overflow-hidden min-h-[380px] md:min-h-[420px]">
                ...
                <div className="relative z-10 p-8 md:p-12 h-full flex flex-col">
                  <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-auto">Other agencies</h3>
              ...
              <div className="relative rounded-3xl overflow-hidden min-h-[380px] md:min-h-[420px]">
                ...
                {/* Content */}
                <div className="relative z-10 p-8 md:p-12 h-full flex flex-col">
                  <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-auto">All's Well Talent</h3>
