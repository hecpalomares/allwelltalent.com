    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <Link
          ...
          className="font-bold text-2xl md:text-3xl tracking-tighter text-black flex items-center gap-2"
        >
          <div className="w-3 h-3 md:w-4 md:h-4 rounded-full animate-pulse bg-[var(--accent-color)]"></div>
          ALL WELL
        </Link>
